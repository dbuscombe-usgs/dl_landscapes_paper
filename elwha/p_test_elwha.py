...
if __name__ == '__main__':
   ...
   classifier_file = 'elwha_mobilenetv2_96_1000_001.pb'
   ##classifier_file = 'elwha_mobilenetv2_224_1000_001.pb'
   ...
   plt.savefig('elwha_cm_96.png', dpi=300, bbox_inches='tight')
   del fig; plt.close()
