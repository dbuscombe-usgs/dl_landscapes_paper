...
/c/Users/ddb265/AppData/Local/Continuum/anaconda3/envs/tfpy35/python retrain.py --image_dir train/tile_224 \
    ...
    --how_many_training_steps 1000 --learning_rate 0.01 --output_labels labels.txt --output_graph elwha_mobilenetv2_224_1000_001.pb
...
/c/Users/ddb265/AppData/Local/Continuum/anaconda3/envs/tfpy35/python retrain.py --image_dir train/tile_96 \
    ...
    --how_many_training_steps 1000 --learning_rate 0.01 --output_labels labels.txt --output_graph elwha_mobilenetv2_96_1000_001.pb
