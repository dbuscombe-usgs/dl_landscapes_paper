...
for k in range(len(true_files)):
   ...
   true[true==4]= 0 #recode other as rock
   
   true_labels = [x for x in true_labels if not x.startswith('other')]
...
plt.savefig('gc_cm_96_pixclass.png', dpi=300, bbox_inches='tight')
del fig; plt.close()   
